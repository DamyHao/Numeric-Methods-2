...
for cas = casos'
    ...
    p=fliplr(vander(x)); % fem la Vandermonde pero en un seguit de punts m�s ampli per tal de millorar la presici� 
    efesInterpolador=p(:,1:m)*coef'; % �s  l'equivalent al vector de efes pero extret de la interpolacio
...
%i 1) la interpolaci� falla i amb els de chebycheb no, tal com vam estudiar
